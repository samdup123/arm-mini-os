...
/// about I?C, see http://en.wikipedia.org/wiki/I%C2%B2C
///
...
// Defines for PWM
#define BCM2835_PWM_CONTROL 0x0  // 0
#define BCM2835_PWM_STATUS 0x4   // 1
#define BCM2835_PWM0_RANGE 0x10  // 4
#define BCM2835_PWM0_DATA 0x14   // 5
#define BCM2835_FIF0_DATA 0x18   // 6
#define BCM2835_PWM1_RANGE 0x20  // 8
#define BCM2835_PWM1_DATA 0x24   // 9

#define BCM2835_PWMCLK_CNTL 0xA0  // 40
#define BCM2835_PWMCLK_DIV 0xA4   // 41
...
/// Transfers a byte of data to the currently selected I2C slave.
/// (as previously set by \sa bcm2835_i2c_setSlaveAddress)
/// \param[in] buf Buffer of byte to send.
/// \param[in] radd Register Address to write to.
/// \return reason see \ref bcm2835I2CReasonCodes
extern void bcm2835_i2c_write(uint8_t sradd, char* buff);
...
/// require this mode then the standard combined:
///   \sa bcm2835_i2c_write
///   \sa bcm2835_i2c_read
/// are a better choice.
/// Will read from the slave previously set by \sa bcm2835_i2c_setSlaveAddress
/// \param[in] regaddr Buffer containing the slave register you wish to read
/// from. \param[in] buf Buffer of bytes to receive. \param[in] len Number of
/// bytes in the buf buffer, and the number of bytes to received. \return reason
/// see \ref bcm2835I2CReasonCodes
extern void bcm2835_i2c_read(uint8_t sradd, char* buff);
